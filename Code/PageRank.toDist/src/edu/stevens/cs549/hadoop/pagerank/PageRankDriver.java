...
public class PageRankDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 4) // If the number of input arguments is 4
		{
			...
			{
				System.err
						.println("Inside Init: Please check the name of the function you wish to call and try again");
			}
		} else if (args.length == 5) // If number of input arguments is 5
		{
			...
			{
				System.err
						.println("Inside Diff: Please check the name of the function you wish to call and try again");
			}
										...
										// data to composite
		{
			...
			{
				System.err
						.println("Inside Composite : Please check the name of the function you wish to call and try again");
	...
	static void init(String input, String output, int reducers)
		...
		System.out.println("Maitrey Prajapati - 10445262");
...
//		Scanner printVal = new Scanner(new File("/"+output+"/output.txt"));
//
//		while (printVal.hasNextLine())
//		{
//		   System.out.println(printVal.nextLine());
//		}
//		printVal.close();
